...
public class FSM_SeekMidZone : StateMachineBehaviour
{
    ...
    {
        _player.direction = (_player.midZone.transform.position - _player.transform.position).normalized;
        ...
        if (!_player.team.midZone.ballInMidZone && !_player.team.dangerZone.ballInDangerZone)
        {
            animator.SetBool("Seek Danger Zone", false);
            animator.SetBool("Seek Mid Zone", false);
        }
